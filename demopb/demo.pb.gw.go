...
func RegisterDemoGatewayHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DemoGatewayServer) error {
	...
	mux.Handle("POST", pattern_DemoGateway_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_DemoGateway_Echo_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_DemoGateway_Echo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDemoGatewayHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DemoGatewayClient) error {
	...
	mux.Handle("POST", pattern_DemoGateway_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DemoGateway_Echo_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_DemoGateway_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"demo", "echo"}, "", runtime.AssumeColonVerbOpt(true)))
)
